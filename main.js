...
const myHearts = ['Ev', 'Ma', 'Ch', 'Ha', 'El'];
console.log(myHearts[0])
console.log(myHearts[1])
console.log(myHearts[2])
console.log(myHearts[3])
console.log(myHearts[4])
...
const newArr = students.slice(4, 6)
console.log(students.slice(4, 6))
...
const joinedDino = dinosaurs.join('*');
...
const colorConcat = primaries.concat(secondaries)
for (let i = 0; i < 1; i++) {
